...
class Interceptor extends \Magento\Framework\Url\RouteParamsResolver implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\RequestInterface $request, \Magento\Framework\Url\QueryParamsResolverInterface $queryParamsResolver, array $data = array(), \Magento\Framework\Url\ParamEncoder $paramEncoder = null)
    {
        $this->___init();
        parent::__construct($request, $queryParamsResolver, $data, $paramEncoder);
    }
